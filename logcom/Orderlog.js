              ...
              return(
                  <tr key={index}>
                      ...
                      <td> {(item.split(","))} 
                            ...
                            <div class="col-md-1"><div class="ab37 ab100" >{item.status}</div></div>
                            <div class="col-md-1"><div class="ab37 ab100" ><td><Button type="button"  variant="danger" id={item.id}  onClick={Invoice}>Generate invoice</Button> </td></div></div>
                          </tr>
                        );
